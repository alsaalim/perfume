(function () {
    ...
    overlay.innerHTML = `
      <div class="buy-now-modal">
        ...
        <form class="bnm-form" novalidate>
          ...
          <input type="email" id="bnm-email" placeholder="your@email.com" autocomplete="email">
          ...
          <div class="bnm-row-2">
            <div>
              ...
              <input type="text" id="bnm-city" placeholder="e.g. Lucknow" autocomplete="address-level2">
              <div class="bnm-error" id="bnm-city-err">Required</div>
            </div>
            <div>
              <label for="bnm-state">State</label>
              <input type="text" id="bnm-state" placeholder="e.g. Uttar Pradesh" autocomplete="address-level1">
  ...
  function collectForm(overlay) {
    ...
    showErr('bnm-email-err', false);
    showErr('bnm-city-err', false);
    showErr('bnm-state-err', false);
  ...
  function handleWhatsApp(overlay) {
    const data = collectForm(overlay);
    if (!data) return;
